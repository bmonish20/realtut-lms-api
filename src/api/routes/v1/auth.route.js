 ...
 */
router
  .route("/register-via-invite")
  .post(validate(registerViaInvite), controller.registerViaInvite);
...
/**
 * @api {post} v1/auth/verify-code   Email Verification
 * @apiDescription Verify the code sent to the user's email and create an account if valid
 * @apiVersion 1.0.0
 * @apiName VerifyCode
 * @apiGroup Auth
 * @apiPermission public
 *
 * @apiParam {String}     email   User's email
 * @apiParam {String{4}}  code    Verification code sent to user's email
 *
 ...
 *
 * @apiError (Unauthorized 401) Unauthorized  Incorrect or expired verification code
 */
router
  .route("/verify-code")
...
/**
 * @api {post} v1/auth/resend-verification   Re-Send Email with verification code
 * @apiDescription Re-send email to the user's email with new verification codes
 * @apiVersion 1.0.0
 * @apiName VerifyCode
 * @apiGroup Auth
 * @apiPermission public
 ...
 * @apiParam {String}     email   User's email
 *
 * @apiSuccess (Success 200) {String}  Email sent to user's email id.
 *
 * @apiError (Badrequest 400) Bad Request  Email id is invalid
 */
router
